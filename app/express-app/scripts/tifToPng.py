...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='separtes the 3 channels on a tif image and it gives back 2 pngs (one for each channel)')
    ...
    cv2.imwrite(output_path + "/" + f.replace(".tif", "_i.png"), im_scaled0)
    ...
    cv2.imwrite(output_path + "/" + f.replace(".tif", "_q.png"), im_scaled1)
    ...
    cv2.imwrite(output_path + "/" + f.replace(".tif", "_coh.png"), im_scaled2)