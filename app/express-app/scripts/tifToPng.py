...
if __name__ == '__main__':
    ...
    for f in tqdm(listFiles):
        ...
        cv2.imwrite(output_path_png + "/" + f.replace(".tif", "_i.png"), im_scaled1)
        ...
        # Écrire les données de l'image normalisées et mises à l'échelle dans un nouveau fichier
        cv2.imwrite(output_path_png + "/" + f.replace(".tif", "_q.png"), im_scaled2)
        ...
        # Écrire les données de l'image normalisées et mises à l'échelle dans un nouveau fichier
        cv2.imwrite(output_path_png + "/" + f.replace(".tif", "_coh.png"), im_scaled2)