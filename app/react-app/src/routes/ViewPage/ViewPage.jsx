    ...
    return (
        <>
            <Splitter className={"h-[calc(100vh-4rem)]"}>
                <SplitterPanel size={20} minSize={20} className={"p-4"}>
                    ...
                    <div className={"flex flex-col"}>
                        <label className={"label cursor-pointer"}>
                            ...
                            <input type="radio" className={"radio"} name={"image-type"} onChange={handleImageTypeChange}
                ...
                <Splitter layout={"vertical"} className={"h-[calc(100vh-4rem)]"}>
                        <SplitterPanel size={30} minSize={30}>
                            <AreaSelector className={"w-full h-full"} inputClasses={"w-full h-full"} inputPolygon={previewPolygon}/>
                        </SplitterPanel>
